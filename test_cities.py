...
class TestCity(unittest.TestCase):
    ...
    def test_1(self):
        ...
        res = self.NERInstance.getCity(testing_address)
        self.assertEqual(res, (None, None))

    def test_2(self):
        testing_address = 'город липецк улица катукова 36 а'
        res: AddressNERHypothesis = self.NERInstance.getCity(testing_address)
...
if __name__ == '__main__':
    ...
    list_of_addresses = ['город липецк улица катукова 36 а',
