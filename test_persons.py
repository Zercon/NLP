import unittest
from Finder import PersonNERHypothesis

class TestPersons(unittest.TestCase):
    def setUp(self):
        self.NERInstance = PersonNERHypothesis()

    def test_1(self):
        testing_address = 'Иванов Петр Васильевич'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('Петр', 'Васильевич', 'Иванов'))

    def test_2(self):
        testing_address = 'шипицын дмитрий вячеславович'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('дмитрий', 'вячеславович', 'шипицын'))
        

    def test_3(self):
        testing_address = 'елена владимировна'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('елена', 'владимировна', None))

    def test_4(self):
        testing_address = 'басалаева юлия михайловна'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('юлия', 'михайловна', 'басалаева'))
    ...
    def test_6(self):
        ...
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, (None, None, 'глушенков'))

    def test_7(self):
        testing_address = 'фамилию сказать что за фамилия терентьева людмила'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('людмила', None, 'терентьева'))
    ...
    def test_9(self):
        ...
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('анюта', None, None))

    def test_10(self):
        testing_address = 'р1 артем витальевич'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('артем', 'витальевич', None))
        
    def test_11(self):
        testing_address = 'фитнес веретельников олег викторович'
        res = self.NERInstance.getFullName(testing_address)
        self.assertEqual(res, ('олег', 'викторович', 'веретельников'))
